<ul class="nav nav-tabs" role="tablist" id="completed-task-data">
			@if(!empty($complete_orderlist->data))
			  ...
			  <li role="presentation" >
			   <a href="#Sections3-{{$i}}" aria-controls="#Sections3-{{$i}}" @if($i==1)class="active" @endif role="tab" data-toggle="tab" data-value="{{$i}}" onclick="tracking_details('@if(!empty($staff_order->bucket_id)){{$staff_order->bucket_id}}@endif',$(this).data('value'))" >
                ...
                <!-- Tab panes -->
  	   <div class="tab-content tabs commond_sidebar_tabcontent" id="completed-task-data1">
			@if(!empty($complete_orderlist->data))
				@php $i=0; @endphp
				@foreach($complete_orderlist->data as $staff_order)
				@php $i++; @endphp
		  	<div role="tabpanel" class="commond_side_bar_fixed tab-pane @if($i==1) active @endif" id="Sections3-{{$i}}">
				...
				<div class="fixed_task_detail dff">
						...
						<div class="d-flex align-items-center justify-content-between">
							<div class="customer_online_detail">						
								...
								<div>
									...
									<p style="color: #ff0000;">Completed</p>
								</div>												
							</div>
				     ...
				     <div class="body-small-details assign-ninja-boxx">
				   	...
				   	<div class="tracking-detail-box">
					  	<div class="traking_details">
						    ...
						    <div class="accordion" id="completed_tracking_accordion-{{$i}}">
