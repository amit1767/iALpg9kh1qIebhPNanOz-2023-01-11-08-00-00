					...
					<div class="order-main-box-nav">
					  ...
					  <div class="zones-reach-boxx">
						<div class="zones-reach-text">
						 ...
						 <p> <strong>@if(!empty($staff_order->address->label)){{$staff_order->address->label}}@endif:</strong> @if(!empty($staff_order->address->description)) {{$staff_order->address->description}} @endif</p>
