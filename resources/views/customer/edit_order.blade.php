	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-5 col-md-12">
				...
				<h3> Edit Order </h3>
				<p> <small> <i class="fas fa-chart-pie"></i> </small> <small> Customers </small> > <small> Edit Order </small> </p>
				</div>
			</div>
				...
				<div class="add-new-order-tabss-nav">
					...
					<div class="card-body" id="msform">
											...
											<div class="p-3">
												<div  id="c_service_selected">
													...
													@php $total+=$item->cost; @endphp
														...
														<!-- <div class="d-flex align-items-center justify-content-between fw-bold"> <p>@if(!empty($item->name)){{$item->name}}@endif</p> <p>@if(!empty($item->cost)){{$item->cost}}@endif AED</p> </div> -->
													@endforeach
													@endif
												</div>
													...
													<div class="service_row2">
														<p> Subtotal </p>
														<p> <b><span class="subtotal"> {{$total}} </span> AED</b> </p>				 
													</div>
													<div class="service_row2">
														<p> VAT </p>
						...
						<fieldset>
							...
							<a href="{{url('dashboard/viewcustomer')}}/{{$customerdata->_id}}" class="danger-custom-btn wizard_cancle_btn"><i class="fas fa-times"></i>  Cancel  </a>
							<button type="submit" onclick="document.getElementById('editorderButton').click()" class="action-button gree-custom-btn wizard_next_btn">Submit <i class="fas fa-chevron-right"></i></button>				
						</fieldset>	
