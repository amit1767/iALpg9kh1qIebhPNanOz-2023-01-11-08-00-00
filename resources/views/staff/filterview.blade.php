		  ...
		  <div class="track-ninja-list">
			<div class="table-responsive mt-3">
				...
				@endphp	
						...
						<?php if($staff->cleaner_city==$city_id){ ?>
					...
					@endphp
					    ...
					    <tr class="@if($num%2==0) even @else odd @endif " role="row">
							...
							<td>
							   ...
							   <p class="{{$color}}-text"><small> <strong>ID-</strong> {{$staff->id}} </small> </p>
					...
					<div class="main-info-headingg">
					 ...
					 <div class="info-window-inner">
					  <div class="left-view-map">
					   <p><strong> Name </strong> <br> '.$staff->cleaner_first_name.' '.$staff->cleaner_last_name.' </p>
					   <p><strong>Status</strong> <br> <span class="'.$color.'-text"><strong> '.$av_status.' </strong> </span> </p>
					   <p><strong> Service Charges </strong> <br> 110 AED </p>
					   <p> </p>
					  </div>
					  <div class="right-view-map">
					   <p><strong> Staff Role </strong> <br> <span class="'.$color.'-text"> <strong>Ninja</strong> </span> </p>
					   <p><strong> Current Order ID </strong> <br> 12431234 </p>
					   <p><strong> Order Address </strong> <br> Al Rigga Dubai </p>
					  </div>
					  </div>
					</div>',
					$lat,
