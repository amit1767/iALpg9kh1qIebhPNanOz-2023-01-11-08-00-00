	...
	<div class="container-fluid">
	  ...
	  <div class="row">
		<div class="col-lg-4 col-md-12">
		   ...
		   <h3> Staff Report </h3>
		   <p> <small> <img class="common_dash_top_icon" src="{{asset('public/assets/image/dashbaord_Icon.png')}}" alt=""> </small> > <small> Staff Report </small> </p>
		  </div>
		</div>
						...
						<div class="modal-content">
							...
							<div class="modal-body">
							    ...
							    <div class="col-set-box connected-sortable droppable-area1">
								  ...
								  <p class="draggable-item"> <input type="checkbox"/> <span>Customer Name <span class="ti-move"></span> </p>
								  <p class="draggable-item"> <input type="checkbox"/> <span>Plate Number <span class="ti-move"></span></p>
								  <p class="draggable-item"> <input type="checkbox"/> <span>Manufacturer <span class="ti-move"></span> </p>
								  <p class="draggable-item"> <input type="checkbox"/> <span>Category </span> <span class="ti-move"></span> </p>
			  ...
			  <div class="form-toggle-box change_periode_box">
				 ...
				 <form action="" method="">
				   	...
				   	<div class=" change_period_date_filed input-group d-flex date_filed">					
						...
						<input type="text" id="Staffreport-change-periode" class="change_period_daterange" placeholder="To" >						
					</div>
			...
			<div id="example_wrapper" class="dataTables_wrapper">
			 <table id="example" class="display dataTable" role="grid" aria-describedby="example_info">
				<thead>
					...
					<th class="sorting_desc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Customer Name: activate to sort column ascending" aria-sort="descending">Customer Name</th>
					...
					<th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Manufacturer: activate to sort column ascending">Manufacturer </th>
					<th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Category Type: activate to sort column ascending">Category</th>
				...
				<tr role="row">
					...
					<td>Body wash, Super Keno Shine, Interior Safe</td>
					<td> <a href="#" class="order-confirm-btn"> Confirmed </a> </td>
				</tr>
				<tr role="row">
					<td class="">57050</td>
					<td class="sorting_1"><strong> Mohammad Naziur </strong></td>
...
$(function() {
$("#Staffreport-change-periode").daterangepicker();
});
